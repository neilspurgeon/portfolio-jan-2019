...
const ProjectImage = props => {
  if (props.layout === 'twoUpLeftBleed')
    return (
      <RevealImage className={styles.imageWrapper}>
        <div className={styles.twoUpLeftBleed} style={props.backgroundStyle}>
          <Image
            className={[styles.twoUpLeft, styles.image].join(' ')}
            image={props.images[0].image}
            altText={props.images[0].altText}
          />
          <Image
            className={[styles.twoUpRight, styles.image].join(' ')}
            image={props.images[1].image}
            altText={props.images[1].altText}
          />
        </div>
      </RevealImage>
    );

  if (props.layout === 'twoUp')
    return (
      <RevealImage className={styles.imageWrapper}>
        <div className={styles.twoUp} style={props.backgroundStyle}>
          <Image
            className={[styles.twoUpImg, styles.image].join(' ')}
            image={props.images[0].image}
            altText={props.images[0].altText}
          />
          <Image
    ...
    return (
      <RevealImage className={styles.imageWrapper}>
        <div className={styles.twoUpStacked} style={props.backgroundStyle}>
          <Image
            className={[styles.twoUpStackedTop, styles.image].join(' ')}
            image={props.images[0].image}
            altText={props.images[0].altText}
          />
          <Image
            className={[styles.twoUpStackedBottom, styles.image].join(' ')}
            image={props.images[1].image}
            altText={props.images[1].altText}
          />
        </div>
      ...
      <RevealImage className={styles.imageWrapper}>
        <div className={styles.threeUpMobile} style={props.backgroundStyle}>
          {props.images.map(project => {
            return (
              <Image
                className={[styles.threeUpMobileImage, styles.image].join(' ')}
                image={project.image}
